    ...
    <div className="w-full">
      <div
        className={`relative border-2 border-dashed rounded-xl p-8 ${
          dragActive
            ? "border-brand-navy dark:border-blue-400"
            : "border-gray-300"
      ...
      <div className="mt-6 flex items-start p-4 bg-brand-gold/10 dark:bg-yellow-400/10 rounded-lg">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-medium">Important:</span> Currently, we only
          support on-campus courses. Online course distributions will be
